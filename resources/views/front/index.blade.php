                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">$ {{$home_product_attr[$productArr->id][0]->mrp}}</span>
                              <span class="aa-product-price"><del>$ {{$home_product_attr[$productArr->id][0]->price}}</del></span>
                              @endif
                            </figcaption>
                          </figure>                         
                  ...
                  <ul class="aa-product-catg aa-featured-slider">
                    ...
                    @if(isset($home_featured_product[$list->id][0]))
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img width="300px" src="{{asset('/storage/media/'.$productArr->image)}}" alt="{{$productArr->name}}"></a>
                            <a class="aa-add-card-btn"href="{{url('product/'.$productArr->slug)}}" onclick="home_add_to_cart('{{$productArr->id}}', '$home_product_attr[$productArr[0]->id][0]->size_id', '$home_product_attr[$productArr[0]->id][0]->color_id')"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              @if(isset($home_featured_product_attr[$productArr->id][0]))
                              <span class="aa-product-price">$ {{$home_featured_product_attr[$productArr->id][0]->mrp}}</span>
                              <span class="aa-product-price"><del>$ {{$home_featured_product_attr[$productArr->id][0]->price}}</del></span>
                              @endif
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                    ...
                    @if(isset($home_tranding_product[$list->id][0]))
                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              @if(isset($home_tranding_product_attr[$productArr->id][0]))
                              <span class="aa-product-price">$ {{$home_tranding_product_attr[$productArr->id][0]->mrp}}</span>
                              <span class="aa-product-price"><del>$ {{$home_tranding_product_attr[$productArr->id][0]->price}}</del></span>
                              @endif
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                    ...
                    @if(isset($home_discounted_product[$list->id][0]))
                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              <h4 class="aa-product-title"><a href="{{url('product/'.$productArr->slug)}}">{{$productArr->name}}</a></h4>
                              @if(isset($home_discounted_product_attr[$productArr->id][0]))
                              <span class="aa-product-price">$ {{$home_discounted_product_attr[$productArr->id][0]->mrp}}</span>
                              <span class="aa-product-price"><del>$ {{$home_discounted_product_attr[$productArr->id][0]->price}}</del></span>
                              @endif
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
